    ...
    <div className="max-w-lg mx-auto">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-slate-900 mb-2">
          Let's Talk About Your Non-Profit
        </h2>
        <p className="text-slate-500">
          Non-profit formation has unique requirements — from tax-exempt status to board structure. We'd love to learn more about your goals and guide you through the process.
        </p>
      </div>
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 mb-6">
        ...
        <ul className="space-y-2.5">
          {[
            ...
            'Tax-exempt status requirements (501(c)(3), etc.)',
            'Board structure and governance',
            'State-specific filing requirements' + (formData.formationState ? ` for ${formData.formationState}` : ''),
            'A personalized formation plan and timeline',
          ].map((item) => (
